export default function Header(  ) {
    ...
    <div className='skillbridge-header md:tw-flex '>
        <div className="tw-flex tw-items-center ms:tw-justify-center tw-text-center tw-flex-none md:tw-w-[300px] tw-text-2xl tw-font-bold tw-bg-lightBG tw-p-4">
            SKILLBRIDGE
        </div>
        <div  className="tw-p-4 tw-bg-darkBG tw-grow tw-relative md:tw-ps-20 tw-flex tw-items-center tw-justify-center" >
